...
--
-- Host: localhost
-- Generation Time: Dec 01, 2015 at 01:45 PM
...
--
-- Table structure for table `champGet`
--

CREATE TABLE IF NOT EXISTS `champGet` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `champGet`
--

INSERT INTO `champGet` (`id`, `idSalle`, `idChamp`, `idUser`) VALUES
(9, 9, 101, 5);
...
(151, 245, 'Ekko', 'Ekko.png', 'Ekko_0.jpg'),
(152, 222, 'Jinx', 'Jinx.png', 'Jinx_0.jpg'),
(153, 64, 'Lee Sin', 'LeeSin.png', 'Lee Sin_0.jpg'),
(154, 92, 'Riven', 'Riven.png', 'Riven_0.jpg'),
(155, 113, 'Sejuani', 'Sejuani.png', 'Sejuani_0.jpg'),
(156, 16, 'Soraka', 'Soraka.png', 'Soraka_0.jpg'),
(157, 412, 'Thresh', 'Thresh.png', 'Thresh_0.jpg'),
(158, 23, 'Tryndamere', 'Tryndamere.png', 'Tryndamere_0.jpg'),
(159, 67, 'Vayne', 'Vayne.png', 'Vayne_0.jpg'),
(160, 45, 'Veigar', 'Veigar.png', 'Veigar_0.jpg');
...
--
-- Table structure for table `lolSalle`
--

CREATE TABLE IF NOT EXISTS `lolSalle` (
  `id` int(11) NOT NULL,
  `creator` varchar(40) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `lolSalle`
--

INSERT INTO `lolSalle` (`id`, `creator`) VALUES
(9, 'RammfanTheOne');
...
(2, 'Site web personnel avec mon C.V, un jeu du reversi et d''autres fonctionnalités (PHP, SILEX, JS, BOOTSTRAP, JQUERY, HTML)');
...
--
-- Table structure for table `userInSalle`
--

CREATE TABLE IF NOT EXISTS `userInSalle` (
  `id` int(11) NOT NULL,
  `idSalle` int(11) NOT NULL,
  `idUser` int(11) NOT NULL
...
--
-- Dumping data for table `userInSalle`
--

INSERT INTO `userInSalle` (`id`, `idSalle`, `idUser`) VALUES
(7, 9, 5);
...
--
-- Indexes for table `champGet`
--
ALTER TABLE `champGet`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `lolSalle`
--
ALTER TABLE `lolSalle`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `userInSalle`
--
ALTER TABLE `userInSalle`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `champGet`
--
ALTER TABLE `champGet`
...
ALTER TABLE `langue`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `lolSalle`
--
ALTER TABLE `lolSalle`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
...
ALTER TABLE `titre`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `userInSalle`
--
ALTER TABLE `userInSalle`
